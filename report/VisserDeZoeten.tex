...
\end{abstract}
In this paper we investigate how word sense disambiguation and discrimination based on word context can be used to improve word similarity rankings. We propose and implement three novel methods that are based on word clusters and compare them using a human annotated evaluation set. We find that word similarity rankings based on context can have similar performance as single word based methods.
