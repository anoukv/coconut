...
% LOOK AT THIS We train the SVM to predict the label when given a vector that describes the probability distribution of a word's context over agglomerative-clusters latent meanings. 
